...
def get_regressor_search_space(algortihm:str, kernel:str=None) -> Dict :
    ...
    if algortihm == "XGBR":
        ...
        "regressor__regressor__reg_alpha": Real(1e-6, 10.0, prior="log-uniform"),  # L1 regularization
        "regressor__regressor__reg_lambda": Real(1e-6, 10.0, prior="log-uniform"),  # L2 regularization
    }
