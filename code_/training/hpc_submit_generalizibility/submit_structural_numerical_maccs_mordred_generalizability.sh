...
#BSUB -o ${output_dir}/structure_numerical_mordred_NGB_generalizibili_${regressor}.out
#BSUB -e ${output_dir}/structure_numerical_mordred_NGB_generalizibili_${regressor}.err"
