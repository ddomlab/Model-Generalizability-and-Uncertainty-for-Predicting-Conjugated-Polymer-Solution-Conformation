...
#BSUB -J "ecfp_radius${radius}_vector${vector}_${regressor}_${target}_polysize_with_RScaler" 
#BSUB -o "${output_dir}/ecfp_radius${radius}_vector${vector}_${target}_${regressor}_polysize_with_RScaler.out"
#BSUB -e "${output_dir}/ecfp_radius${radius}_vector${vector}_${target}_${regressor}_polysize_with_RScaler.err"
