...
#BSUB -J "structure_only_mordred_${regressor}_with_${scaler}"  
#BSUB -o "${output_dir}/structure_only_mordred_${regressor}_with_${scaler}.out"
#BSUB -e "${output_dir}/structure_only_mordred_${regressor}_with_${scaler}.err"
