...
def parse_arguments():
    ...
    args.numerical_feats = [feat.strip() for feat in args.numerical_feats]
    args.columns_to_impute = [col.strip() for col in args.columns_to_impute] if args.columns_to_impute else []
