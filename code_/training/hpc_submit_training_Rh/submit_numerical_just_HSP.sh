...
#BSUB -J "poly_HSP_with_${model}_on_${target}_no_Ra_solvent"
#BSUB -o "${output_dir}/poly_HSP_with_${model}_on_${target}_no_Ra_solvent.out"
#BSUB -e "${output_dir}/poly_HSP_with_${model}_on_${target}_no_Ra_solvent.err"
