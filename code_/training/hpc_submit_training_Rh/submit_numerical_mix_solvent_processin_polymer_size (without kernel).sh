...
#BSUB -J "numerical_${model}_polymer_size_feats_on_${target}_all_num_20250205"
#BSUB -o "${output_dir}/numerical_${model}__${target}_20250207.out"
#BSUB -e "${output_dir}/numerical_${model}__${target}_20250207.err"
