...
regressors=("XGBR") 
targets=('log Rg (nm)')
group_out=('substructure cluster' 'KM4 polymer_solvent HSP cluster' 'KM4 Mordred_Polysize cluster' 'KM4 ECFP6_Count_512bit cluster' 'KM4 Mordred_Polysize cluster') 
