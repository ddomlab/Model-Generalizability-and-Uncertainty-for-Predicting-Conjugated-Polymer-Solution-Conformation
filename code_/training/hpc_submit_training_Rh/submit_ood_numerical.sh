...
#BSUB -J "${regressor}_${target}_${oligo_rep}_${group}_202505029"  
#BSUB -o "${output_dir}/${regressor}_${target}_${group}_20250529.out"
#BSUB -e "${output_dir}/${regressor}_${target}_${group}_20250529.err"
