...
sns.histplot(np.log10(flattened_df["Rh at peaks (above 1 nm)"]), bins=20, kde=True, color='blue', edgecolor='black')

plt.title('Histogram of Flattened Values', fontsize=16)
